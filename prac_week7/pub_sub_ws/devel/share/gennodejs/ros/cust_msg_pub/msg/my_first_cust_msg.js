...
class my_first_cust_msg {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new my_first_cust_msg(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new my_first_cust_msg(null);
    if (msg.A !== undefined) {
      resolved.A = msg.A;
    }
    else {
...
module.exports = my_first_cust_msg;
