...
(cl:defmethod cl:initialize-instance :after ((m <num_to_add>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num_to_add)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name srv_vect-msg:<num_to_add> is deprecated: use srv_vect-msg:num_to_add instead.")))

(cl:ensure-generic-function 'A-val :lambda-list '(m))
(cl:defmethod A-val ((m <num_to_add>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_vect-msg:A-val is deprecated.  Use srv_vect-msg:A instead.")
  (A m))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <num_to_add>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_vect-msg:B-val is deprecated.  Use srv_vect-msg:B instead.")
  (B m))

(cl:ensure-generic-function 'C-val :lambda-list '(m))
(cl:defmethod C-val ((m <num_to_add>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader srv_vect-msg:C-val is deprecated.  Use srv_vect-msg:C instead.")
  (C m))
